...
|------|------|--------|-------|---------|
| Foundation: PHPP 10 Ground inputs | Feature (upstream `honeybee_ph` #123 / `PHX` #121, #122 released) | **Merged to main** (2026-09-12, [PR #80](https://github.com/PH-Tools/honeybee_grasshopper_ph/pull/80)) — remaining: release, then the default-corrections note in the Release body and archive | [#79](https://github.com/PH-Tools/honeybee_grasshopper_ph/issues/79) | [`features/foundation-ground-inputs/`](features/foundation-ground-inputs/README.md) |
