...
| Set Occupancy list padding | Bug fix | **Requested** — reproduced; not implemented | [#73](https://github.com/PH-Tools/honeybee_grasshopper_ph/issues/73) | [`bugs/occupancy-list-padding.md`](bugs/occupancy-list-padding.md) |
