...
|------|------|--------|-------|---------|
| Foundation: PHPP 10 Ground inputs | Feature (upstream `honeybee_ph` #123 / `PHX` #121, #122 released) | **In review** — canvas-verified; [PR #80](https://github.com/PH-Tools/honeybee_grasshopper_ph/pull/80) open | [#79](https://github.com/PH-Tools/honeybee_grasshopper_ph/issues/79) | [`features/foundation-ground-inputs/`](features/foundation-ground-inputs/README.md) |
