...
| Remove deprecated 'Add PH Equipment' + 'Phius MF Res Calculator' | Refactor (upstream `honeybee_ph` #79 step 1 released 1.33.65) | **Merged to main** (2026-09-12, PR #87; after the v1.39.0 cut) — both dead components, their workers, registry entries, and the MF calc `.ghuser` deleted; `_deprecated_/` package gone. Remaining: canvas Update-GHCompos check, release with notes naming replacements | [#84](https://github.com/PH-Tools/honeybee_grasshopper_ph/issues/84) | issue-only (spec in #84) |
