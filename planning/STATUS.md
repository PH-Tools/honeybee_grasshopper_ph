...
| Create Elec Equip writes the string "None" into numeric equipment fields | Bug fix | **Implemented on branch** (2026-09-15, `fix/create-elec-equip-numeric-inputs`) — `_normalize_input_value` in `set_object_attributes`; CPython stub check passes; canvas check and origin reproduction still pending | [#94](https://github.com/PH-Tools/honeybee_grasshopper_ph/issues/94) | [`bugs/create-elec-equip-none-string.md`](bugs/create-elec-equip-none-string.md) |
