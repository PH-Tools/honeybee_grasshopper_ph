...
|------|-----------|--------|-------|-----|
| ~~Create Elec Equip writes the string "None" into numeric equipment fields~~ | `HBPH - Create PH Equipment` | **Complete 2026-09-15** — archived. Fix released v1.41.0 (PR #95) and canvas-verified; how the text reached the model is unresolved (the float hint blocks it on the canvas). Boolean `False` input found during the check: [#96](https://github.com/PH-Tools/honeybee_grasshopper_ph/issues/96) | [#94](https://github.com/PH-Tools/honeybee_grasshopper_ph/issues/94) | [`../archive/create-elec-equip-none-string.md`](../archive/create-elec-equip-none-string.md) |
