...
class GHCompo_CreateVentSched(object):
    ...
    def __init__(self, _IGH, _name, _operating_days_per_week_, _operating_weeks_per_year_, 
            _op_period_high, _op_period_standard, _op_period_basic, _op_period_minimum):
    ...
    def run(self):
        ...
        name = clean_and_id_ep_string('ConstantSchedule') if self.name is None else \
                clean_ep_string(self.name)
