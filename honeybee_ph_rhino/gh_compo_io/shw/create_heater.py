...
inputs_boiler_oil_gas = {
    ...
    4: ComponentInput(_name="fuel", _description=r'Input: "1-Gas" or "2-Oil"'),
    5: ComponentInput(
        _name="condensing",
    ...
    def _determine_heater_class(self, _type_number):
        ...
        try:
            ...
            msg = "Error: Input Heater Type: '{}' not supported. Please only input: '{}'".format(
                self.heater_type, self.valid_types
            )
            raise Exception(msg)
