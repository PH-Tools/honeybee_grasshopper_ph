...
class GHCompo_ClimateData(object):
    ...
    def __init__(self, _IGH, _display_name, _station_elevation, _daily_temp_swing, _average_wind_speed, _monthly_temps, _monthly_radiation, _peak_heat_load_1, _peak_heat_load_2, _peak_cooling_load_1, _peak_cooling_load_2):
