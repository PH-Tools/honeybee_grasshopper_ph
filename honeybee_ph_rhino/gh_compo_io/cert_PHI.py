...
inputs_phpp_9 = {
    1: ComponentInput(_name='- '*20,
                      _description="",
                      _type_hint=Component.NewStrHint()),
    2: ComponentInput(_name='_building_category_type',
                      ...
                      _type_hint=Component.NewStrHint()),
    3: ComponentInput(_name='_building_use_type',
                      _description=_build_options_string(
                            [
                                "10-Dwelling (default)",
                      ...
                      _type_hint=Component.NewStrHint()),
    4: ComponentInput(_name='_ihg_type',
                      _description=_build_options_string(
                            [
                                "2-Standard (default)",
                      ...
                      _type_hint=Component.NewStrHint()),
    5: ComponentInput(_name='_occupancy_type',
                      _description=_build_options_string(
                            [
                      ...
                      _type_hint=Component.NewStrHint()),
    6: ComponentInput(_name='- '*20,
                      _description="",
                      _type_hint=Component.NewStrHint()),
    7: ComponentInput(_name='_certification_type',
                      _description=_build_options_string(
                            [
                      ...
                      _type_hint=Component.NewStrHint()),
    8: ComponentInput(_name='_certification_class',
                      _description=_build_options_string(
                            [
                                "1-Classic (default)",
                                "2-Plus",
                      ...
                      _type_hint=Component.NewStrHint()),
    9: ComponentInput(_name='_primary_energy_type',
                      _description=_build_options_string(
                            [
                                "1-PE (non-renewable)",
                      ...
                      _type_hint=Component.NewStrHint()),
    10: ComponentInput(_name='_enerphit_type',
                      _description=_build_options_string(
                            [
                                "1-Component method",
                      ...
                      _type_hint=Component.NewStrHint()),
    11: ComponentInput(_name='_retrofit',
                      _description=_build_options_string(
                            [
