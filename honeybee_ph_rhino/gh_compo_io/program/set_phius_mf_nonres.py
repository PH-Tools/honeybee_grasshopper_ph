...
"""GHCompo Interface: HBPH - Set Phius Multi-Family Non-Residential Room Loads."""
...
def build_lighting_int(total_lighting_int, number_of_rooms):
    ...
    lighting_obj.comment = "LIGHTS_Int_Comm"
...
class GHCompo_SetPhiusMFNonResidentialRoomLoads(object):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.total_lighting_int = _total_lighting or 0.0
