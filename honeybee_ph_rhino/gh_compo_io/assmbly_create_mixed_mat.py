...
class GHCompo_CreateMixedHBMaterial(object):
    ...
    def __init__(self, IGH,  _name_, _section_1_material, _section_1_percentage,
        _section_2_material, _section_2_percentage, _section_3_material, _section_3_percentage):
    ...
    def materials(self):
        ...
        all_materials = (self.section_1_material, self.section_2_material, self.section_3_material)
    ...
    def clean_percentages(self, _sec_1_perc, _sec_2_perc, _sec_3_perc):
        ...
        if sec_1_perc < 0.0:
            ...
            msg = "Error: The total material percentages = {:.2%}? Total should add up to 100.0% exactly?".format(total_input_percentage)
            self.IGH.error(msg)
    ...
    def check_conductivities(self, _limit=5.0):
        ...
        for material in self.materials:
            if material.conductivity > _limit:
                msg = "Error: High Conductivity found ({} W/mk) for material '{}'\n"\
