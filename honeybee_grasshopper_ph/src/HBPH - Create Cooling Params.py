...
#
"""
Define cooling-parameters which are set on a PH heat-pump system. Connect the 'cooling_params_'
output of this component to one of the '_cooling_params_' inputs on a 'Create Space 
Conditioning System' component in order to add the cooling attributes of the heat pump.
-
...
"4-Radiant Panel"
    ...
    Returns:
        cooling_params_: The new PH-HVAC Cooling Params which can be set on a space-conditioning 
            heat-pump system.
"""
...
if DEV:
    reload(gh_io)
    from honeybee_ph_rhino.gh_compo_io.hvac import create_cooling_params as gh_compo_io
    reload(gh_compo_io)
