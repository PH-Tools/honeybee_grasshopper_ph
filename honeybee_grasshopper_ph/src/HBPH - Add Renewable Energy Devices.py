...
#
"""
Add HBPH Renewable Energy Systems (PV, etc..) to one or more Honeybee Rooms.
-
EM June 14, 2023
    Args:
    ...
    Returns:
        hb_rooms_: The input hb-rooms with the new HBPH Renewable Systems added.
"""
...
if DEV:
    from honeybee_ph_rhino.gh_compo_io import mech_add_renewable_system as gh_compo_io
