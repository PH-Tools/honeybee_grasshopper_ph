...
#
"""
Create new HBPH Hot-Water 'Trunk' Piping Object.

A 'Trunk' pipe will have one or more 'Branch' pipes connected to it. Trunk pipes are 
passed directly to a HBPH SHW System.
-
EM September 19, 2022
...
if DEV:
    ...
    reload(hot_water)
    from honeybee_ph_rhino.gh_compo_io import shw_create_pipe_trunks as gh_compo_io
    reload(gh_compo_io)
    reload(gh_io)
