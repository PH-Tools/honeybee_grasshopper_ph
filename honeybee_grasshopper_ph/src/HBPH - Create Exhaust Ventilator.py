...
#
"""
Create a new PH-HVAC Exhaust Ventilator for use in WUFI-Passive models. This device 
...
if DEV:
    ...
    from honeybee_ph_rhino.gh_compo_io.hvac import create_exhaust_vent as gh_compo_io
...
# -------------------------------------------------------------------------------------
gh_compo_interface = gh_compo_io.GHCompo_CreateExhaustVent(IGH, _name, _type, _flow_rate_m3s, _annual_runtime_minutes)
