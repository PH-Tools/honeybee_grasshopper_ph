...
if DEV:
    from honeybee_ph_rhino.gh_compo_io.shading import shade_solve_shading_dims as gh_compo_io
...
# -------------------------------------------------------------------------------
gh_compo_interface = gh_compo_io.GHCompo_SolveShadingDims(IGH, _shading_surfaces, _hb_rooms, _run)
