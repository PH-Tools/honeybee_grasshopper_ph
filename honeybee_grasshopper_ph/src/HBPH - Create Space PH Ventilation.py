...
EM October 2, 2022
    Args:
        ...
        _v_eta: (float): A list or Tree of Extract-air ventilation flow rates (m3/s).
        
        _v_tran: (float): A list or Tree of Transfer-air ventilation flow rates (m3/s).
...
# ------------------------------------------------------------------------------
ghio_obj = gh_compo_io.GHCompo_CreateSpaceVent(IGH, _v_sup, _v_eta, _v_tran)
